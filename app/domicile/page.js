      ...
      <section id="comment" className={styles.seoSection}>
        <div className="container" style={{position: 'relative', zIndex: 2}}>
          ...
          <div className={styles.seoTextGlass}>
            ...
            <p>
              Votre temps est précieux. C'est pourquoi ReparPhone propose un service de réparation d'iPhone directement à domicile. Que vous habitiez en centre-ville ou en banlieue, nos techniciens certifiés se déplacent pour effectuer le changement d'écran de votre iPhone 14, ou remplacer la batterie de votre iPhone 12 Pro. Plus besoin de patienter des heures en magasin, le service est rapide, sécurisé et garanti 1 an.
            </p>
