export const metadata = {
  ...
  description: 'Revendez votre ancien smartphone au meilleur prix chez ReparPhone. Estimation gratuite, tous états acceptés (écran cassé). Paiement cash immédiat !',
};
        ...
        <div className={`container ${styles.contentContainer}`}>
          <div className={styles.textLeft}>
            ...
            <p className={styles.subtitle}>
              ...
              ReparPhone rachète vos anciens smartphones, tablettes et ordinateurs. 
      ...
      <section className={styles.seoSection}>
        ...
        <div className="container" style={{position: 'relative', zIndex: 2}}>
          ...
          <div className={styles.seoText}>
            ...
            <p>
              Vous possédez un iPhone 15, iPhone 14 Pro Max, iPhone 13, iPhone 12 ou même un modèle plus ancien comme l'iPhone 11 ou le XR ? ReparPhone est spécialisée dans le rachat de produits Apple. L'écosystème Apple conserve une excellente valeur sur le marché de l'occasion. Nous vous proposons les meilleurs tarifs de reprise, que votre vitre arrière soit brisée, que le Face ID ne fonctionne plus, ou que la capacité de la batterie soit faible.
            </p>
