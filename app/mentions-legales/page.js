export const metadata = {
  title: 'Mentions Légales | ReparPhone',
  description: 'Mentions légales du site ReparPhone, réparation de téléphones à Toulouse.',
};
    ...
    <div className="container" style={{ paddingTop: '120px', paddingBottom: '80px', minHeight: '80vh' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem', color: 'var(--foreground)' }}>
        <section>
          ...
          <p>Le site <strong>ReparPhone</strong> est édité par l'entreprise ReparPhone.</p>
        ...
        <section>
          ...
          <p>ReparPhone s'efforce d'assurer au mieux de ses possibilités l'exactitude et la mise à jour des informations diffusées sur ce site, dont elle se réserve le droit de corriger à tout moment et sans préavis le contenu. Toutefois, ReparPhone ne peut garantir l'exactitude, la précision ou l'exhaustivité des informations mises à la disposition sur ce site.</p>
        </section>
      </div>
    </div>
  );
