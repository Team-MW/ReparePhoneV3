export const metadata = {
  title: 'Politique de Confidentialité | Répare Phone',
  description: 'Politique de confidentialité et traitement des données personnelles par Répare Phone.',
};
    ...
    <div className="container" style={{ paddingTop: '120px', paddingBottom: '80px', minHeight: '80vh' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem', color: 'var(--foreground)' }}>
        <section>
          ...
          <p>Les informations recueillies via nos formulaires (nom, prénom, numéro de téléphone, adresse email, modèle d'appareil) sont enregistrées par <strong>Répare Phone</strong> pour faciliter les échanges, la prise de rendez-vous et l'établissement de devis.</p>
        </section>

        <section>
          <h2 style={{ color: 'var(--primary)', marginBottom: '1rem', fontSize: '1.5rem', fontWeight: 'bold' }}>2. Utilisation des données</h2>
          <p>Les données collectées sont utilisées exclusivement par l'équipe de Répare Phone pour vous recontacter suite à votre demande. Elles ne sont en aucun cas vendues, cédées ou louées à des tiers à des fins commerciales.</p>
        </section>
        ...
        <section>
          ...
          <p>Conformément à la loi « informatique et libertés » et au RGPD, vous pouvez exercer votre droit d'accès aux données vous concernant et les faire rectifier ou supprimer en nous contactant à : <strong>contact@reparephone.fr</strong>.</p>
        </section>
